...
-- 正在导出表  typecho.typecho_contents 的数据：26 rows
...
-- 正在导出表  typecho.typecho_metas 的数据：43 rows
...
INSERT INTO `typecho_metas` (`mid`, `name`, `slug`, `type`, `description`, `count`, `order`, `parent`) VALUES
	...
	(17, '其他技术', 'other-tech', 'category', NULL, 3, 3, 0),
	...
	(42, 'react', 'react', 'tag', NULL, 3, 0, 0),
	(43, 'redux', 'redux', 'tag', NULL, 1, 0, 0),
	(44, 'flux', 'flux', 'tag', NULL, 1, 0, 0),
	(45, '框架', '框架', 'tag', NULL, 1, 0, 0),
	(46, 'javascript', 'javascript', 'tag', NULL, 5, 0, 0),
...
-- 正在导出表  typecho.typecho_relationships 的数据：61 rows

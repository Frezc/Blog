...
-- 正在导出表  typecho.typecho_contents 的数据：37 rows
...
-- 正在导出表  typecho.typecho_metas 的数据：56 rows
...
INSERT INTO `typecho_metas` (`mid`, `name`, `slug`, `type`, `description`, `count`, `order`, `parent`) VALUES
	...
	(29, 'Web', 'web', 'category', NULL, 5, 4, 0),
...
-- 正在导出表  typecho.typecho_relationships 的数据：90 rows

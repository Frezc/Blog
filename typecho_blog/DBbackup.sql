-- --------------------------------------------------------
-- ホスト:                          115.28.68.215
-- サーバのバージョン:                    5.5.44-MariaDB - MariaDB Server
-- サーバー OS:                      Linux
-- HeidiSQL バージョン:               9.3.0.4998
-- --------------------------------------------------------
...
-- Dumping structure for テーブル typecho.typecho_comments
...
-- Dumping data for table typecho.typecho_comments: 2 rows
...
-- Dumping structure for テーブル typecho.typecho_contents
...
-- Dumping data for table typecho.typecho_contents: 38 rows
...
-- Dumping data for table typecho.typecho_fields: 0 rows
/*!40000 ALTER TABLE `typecho_fields` DISABLE KEYS */;
/*!40000 ALTER TABLE `typecho_fields` ENABLE KEYS */;


-- Dumping structure for テーブル typecho.typecho_links
...
-- Dumping data for table typecho.typecho_links: 1 rows
...
-- Dumping structure for テーブル typecho.typecho_metas
...
-- Dumping data for table typecho.typecho_metas: 59 rows
...
INSERT INTO `typecho_metas` (`mid`, `name`, `slug`, `type`, `description`, `count`, `order`, `parent`) VALUES
	...
	(13, 'App', 'app', 'category', NULL, 4, 2, 0),
	(14, 'android', 'android', 'tag', NULL, 4, 0, 0),
	...
	(29, 'Web', 'web', 'category', NULL, 6, 4, 0),
	...
	(56, '渲染性能优化', '渲染性能优化', 'tag', NULL, 1, 0, 0),
	(57, 'purerendermixin', 'purerendermixin', 'tag', NULL, 0, 0, 0),
	(58, 'pure-render-mixin', 'pure-render-mixin', 'tag', NULL, 1, 0, 0),
	(59, 'appwidgets', 'appwidgets', 'tag', NULL, 1, 0, 0),
	(60, 'asyncstorage', 'asyncstorage', 'tag', NULL, 1, 0, 0),
	(61, 'webpack', 'webpack', 'tag', NULL, 1, 0, 0),
	(62, 'webpack-dev-server', 'webpack-dev-server', 'tag', NULL, 1, 0, 0),
	(63, 'hotmodulereplacementplugin', 'hotmodulereplacementplugin', 'tag', NULL, 1, 0, 0);
/*!40000 ALTER TABLE `typecho_metas` ENABLE KEYS */;


-- Dumping structure for テーブル typecho.typecho_relationships
...
-- Dumping data for table typecho.typecho_relationships: 95 rows

...
-- 正在导出表  typecho.typecho_contents 的数据：9 rows
...
-- 正在导出表  typecho.typecho_metas 的数据：25 rows
...
INSERT INTO `typecho_metas` (`mid`, `name`, `slug`, `type`, `description`, `count`, `order`, `parent`) VALUES
	...
	(29, 'Web', 'web', 'category', NULL, 1, 4, 0);
...
-- 正在导出表  typecho.typecho_relationships 的数据：30 rows

...
-- 正在导出表  typecho.typecho_contents 的数据：27 rows
...
-- 正在导出表  typecho.typecho_metas 的数据：46 rows
...
INSERT INTO `typecho_metas` (`mid`, `name`, `slug`, `type`, `description`, `count`, `order`, `parent`) VALUES
	...
	(29, 'Web', 'web', 'category', NULL, 3, 4, 0),
	...
	(42, 'react', 'react', 'tag', NULL, 4, 0, 0),
	(43, 'redux', 'redux', 'tag', NULL, 2, 0, 0),
...
-- 正在导出表  typecho.typecho_relationships 的数据：69 rows
